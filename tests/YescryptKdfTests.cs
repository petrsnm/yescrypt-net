...
namespace tests
{
    ...
    public class YescryptKdfTests
    {
        ...
        public void DeriveKeyTest()
        {
            ...
            dk = kdf.DeriveKey(Encoding.ASCII.GetBytes("password"), Encoding.ASCII.GetBytes("salt"), 64);
            ...
            dk = kdf.DeriveKey(Encoding.ASCII.GetBytes("password"), Encoding.ASCII.GetBytes("salt"), 32);
            CollectionAssert.AreEqual(expected, dk);

            expected = new byte[] {
                0xbf, 0x55, 0x15, 0xcf, 0x4a, 0xf1, 0xd8, 0x39, 0xdc, 0x71, 0x92, 0xbd, 0xc2, 0x30, 0x58, 0x79
            };
            dk = kdf.DeriveKey(Encoding.ASCII.GetBytes("password"), Encoding.ASCII.GetBytes("salt"), 16);
            CollectionAssert.AreEqual(expected, dk);
        }
    }
}
